CREATE TABLESPACE cs360_tablespace DATAFILE 'cs360_tablespace.dat' SIZE 10M AUTOEXTEND ON;
CREATE TEMPORARY TABLESPACE cs360_tablespace_temp TEMPFILE 'cs360_tablespace_temp.dat' SIZE 5M AUTOEXTEND ON;
